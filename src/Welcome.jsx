...
const Welcome = ({ onClose, children }) => (
  <div className="fixed inset-0 z-50 flex justify-center items-center">
    ...
    <motion.div
      ...
      className="relative z-10 flex justify-center items-center pointer-events-none  backdrop-blur-sm font-dm-sans tracking-tight w-full h-full"
    >
      <motion.div
